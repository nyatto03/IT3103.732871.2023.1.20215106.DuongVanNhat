    ...
    public static void storeMenu() {
        ...
        switch (choice) {
            ...
            case 1:
                ...
                // Trong lựa chọn 1 , lấy tên media rồi tìm nó trong store, nếu tìm thấy vào
                // mediaDetailsMenu
            ...
            case 3:
                ...
                if (foundMedia instanceof CompactDisc) {
                    ...
                    try {
                        ...
                        // You can display a dialog box to the user with the content of the exception
                        // here
                    }
        ...
        switch (detailMenuChoice) {
            ...
            case 2:
                if (check == 0) {
                    System.out.println("Error, choose again!");
                    mediaDetailsMenu();
                    // Nếu media không phải loại play được thì không có lựa chọn 2, coi nó như lựa
                    // chọn lõi
                } else {
                    if (foundMedia instanceof CompactDisc) {
                        CompactDisc cd = (CompactDisc) foundMedia;
